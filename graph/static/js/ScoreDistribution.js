                ...
                data => { // data contiendra l'objet JSON
                    if (data.response_data) {
                        ...
                        Plotly.relayout(graphDiv, {
                            'title': {
                                text: `Évolution des scores de performance (${scoreType})`,
                                font: {
                        ...
                        for (const sexe of ['M', 'F']) {
                            const sexeData = data.response_data.plot_data[`contour_${sexe}`];
                            ...
                            const trendData = data.response_data.plot_data[`trend_${sexe}`];
                            ...
                            if (trendData) {
                                ...
                                if (trendIndex !== -1) {
                                    ...
                                    const minYear = data.response_data.min_year;
                                    const maxYear = data.response_data.max_year;
                        ...
                        const str_y_title =  'score de performance ${scoreType}';
                        Plotly.relayout(graphDiv, {
                            yaxis: {
                                title: {
                                    text: str_y_title,
